...
export function getPromptTemplates(): PromptTemplates {
  return {
    ...
    investigationTemplates: {
      'INITIAL_ASSESSMENT': INVESTIGATION_INITIAL_ASSESSMENT_TEMPLATE,
      'FOCUSED_EXPLORATION': INVESTIGATION_FOCUSED_EXPLORATION_TEMPLATE,
      'SELECTOR_DETERMINATION': INVESTIGATION_SELECTOR_DETERMINATION_TEMPLATE
    }
  };
}
